...
export const Slider = () => {
  return (
    <div className="pt-32 bottom-0 slider flex items-center justify-center w-[100vw] h-full bg-transparent relative ">
      <div className="slide-track flex items-end justify-center w-full h-full bg-transparent absolute bottom-0">
        ...
        <SliderItem src={teco} />
        {/* <SliderItem src={Reliance_electric} /> */}
        <SliderItem src={motorUs} />      <SliderItem src={teco} />
        {/* <SliderItem src={Reliance_electric} /> */}
        <SliderItem src={Lincoln_Electric} />
        <SliderItem src={web} />
        <SliderItem src={leeson} />
