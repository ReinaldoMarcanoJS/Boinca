...
export default function Section4() {
  return (
    <section id="services" className=" bg-cyan-800/5 py-20  ">
      <div className="container px-4 md:px-6 space-y-8 md:flex justify-around">
        <div className="text-center space-y-4 items-center flex flex-col justify-center">
          ...
          <div className="space-x-2 min-[700px]:text-base flex gap-2 flex-col text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            <Link
              href={"#ubicacion"}
              className="flex items-center justify-start  h-10 rounded-xl border p-4"
            >
            ...
            <Link
              href={"#section2"}
              className="flex items-center justify-start  h-10 rounded-xl border p-4 ml-2"
            >
        ...
        <div className="flex justify-center  ">
          <iframe
            ...
            width="500"
            height="400"
            className="border-0 hidden xl:block"
            loading="lazy"
          ...
          <iframe
            ...
            width="300"
            height="200"
            className="border-0 block lg:hidden"
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
          ></iframe>
          <iframe
